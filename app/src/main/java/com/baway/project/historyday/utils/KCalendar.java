...
public class KCalendar extends ViewFlipper implements
	...
	public interface OnCalendarDateChangedListener {
		void onCalendarDateChanged(int year, int month,int day);
	}
	 ...
	 * @param month
	 */
	public void showCalendar(int year, int month,int day1) {
		calendarYear = year;
		calendarMonth = month - 1;
		day=day1;
		calendarday = new Date(calendarYear - 1900, calendarMonth,day);
		setCalendarDate();
	}
